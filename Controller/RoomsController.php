...
class RoomsController extends AppController {
	...
	public $uses = array('Room', 'Upsell', 'Location', 'Meal', 'Query', 'Configuration', 'RegType', 'RegItem');
	...
	public function get() {
		...
		$res = array(
			...
			'queries' => $queries,
			'reg_prices' => array(
				'mtm'      => json_decode($reg_types_1, $assoc = TRUE), # assoc true so empty key remains empty (php uses '_empty_' otherwise)
			...
			'suitable_reg_items' => $suitable_reg_items,
