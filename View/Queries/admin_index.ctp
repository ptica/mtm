		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($queries as $query) { ?>
					<tr>
						<td><?php echo h($query['Query']['query']); ?></td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $query['Query']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $query['Query']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $query['Query']['id'])); ?>
						</td>
					</tr>
				<?php } ?>
				</tbody>
