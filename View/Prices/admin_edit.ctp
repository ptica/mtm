	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
							...
							<li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;' . __('Delete'), array('action'=>'delete', $this->Form->value('Price.id')), array('escape'=>false), __('Are you sure you want to delete # %s?', $this->Form->value('Price.id'))); ?></li>
							<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;' . __('List Prices'), array('action'=>'index'), array('escape'=>false)); ?></li>
								...
								<h1><?php echo __('Admin Edit Price'); ?></h1>
			</div>
		</div>
	</div>
